...
export const AuthGate: React.FC<AuthGateProps> = ({ onAuthSuccess }) => {
  ...
  return (
    <div className="auth-light relative min-h-screen text-slate-900 bg-gradient-to-br from-rose-50 via-white to-amber-50 flex items-center justify-center p-4 font-sans">
