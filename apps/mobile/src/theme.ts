...
export const colors = {
  bg: '#1a0a14',          // app base (mostly covered by FloralBackground)
  surface: '#26101c',     // cards / inputs
  surfaceAlt: '#331627',  // selected rows, image fallbacks, progress tracks
  border: '#5a1f38',      // wine card borders
