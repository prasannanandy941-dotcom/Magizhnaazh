...
echo "       event / event-api / event-customer / event-admin / event-vendor .porulontech.com"
echo "  2. Once DNS resolves here, enable HTTPS:"
echo "       sudo certbot --nginx -d event.porulontech.com -d event-api.porulontech.com -d event-customer.porulontech.com -d event-admin.porulontech.com -d event-vendor.porulontech.com"
