...
const vendorPackageSchema = new Schema(
  {
    ...
    catering: {
      type: {
        ...
        serviceStyle: String,
        plateTypes: [String],
        plateTypePrices: { type: Schema.Types.Mixed, default: {} },
        plateTypeImages: { type: Schema.Types.Mixed, default: {} },
        leafType: String,
        leafTypePrices: { type: Schema.Types.Mixed, default: {} },
        leafTypeImages: { type: Schema.Types.Mixed, default: {} },
    ...
    decoration: {
      type: {
        ...
        coupleSofa: Boolean,
        coupleSofaPrice: Number,
        coupleSofaImage: String,
        mandapType: String,
        mandapPrice: Number,
        mandapImage: String,
        lighting: Boolean,
